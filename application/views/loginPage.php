		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="<?php echo base_url();?>login/images/BAUET.jpg" alt="IMG">
				</div>

                            <form class="login100-form validate-form" action="<?php echo base_url();?>Welcome/check_Login" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="text" name="memberID" placeholder="Enter Member ID....">
					...
					<div class="text-center p-t-136">
                                            <a class="txt2" href="<?php echo base_url();?>Welcome/registration">
							Create your Account
