                ...
                <section>
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="user-data m-b-30">
                                <h3 class="title-3 m-b-30">
                                    <i class="zmdi zmdi-account-calendar"></i>Student List</h3>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($Student as $student) { 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <font size="3"><?php echo $student->firstName ?></font>
                                                    </td>
                                                    <td>
                                                        <?php echo $student->memberID ?> 
                                                    </td>
                                                    
                                                    <td>
                                                        <a type="submit" style="color: red;" href="<?php echo base_url()?>adminController/changePermissionStudent/<?php echo $student->userID?>/<?php echo $student->permission?>">
                                                            <?php echo $student->permission;?>
                                                        </a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="user-data m-b-30">
                                <h3 class="title-3 m-b-30">
                                    <i class="zmdi zmdi-account-calendar"></i>Teacher List</h3>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($Teacher as $teacher) { 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <font size="3"><?php echo $teacher->firstName ?></font>
                                                    </td>
                                                    <td>
                                                        <?php echo $teacher->memberID?> 
                                                    </td>
                                                    <td>
                                                        <a type="submit" style="color: red;" href="<?php echo base_url()?>adminController/changePermissionTeacher/<?php echo $teacher->teacherID?>/<?php echo $teacher->permission?>">
                                                            <?php echo $teacher->permission?>
                                                        </a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
